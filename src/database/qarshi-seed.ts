...
async function seedImage(name: string, keyword: string, lock: number): Promise<string> {
...
// Categories
// ---------------------------------------------------------------------------
interface CatNode { slug: string; uz: string; cy: string; ru: string; children?: CatNode[] }
const CATEGORY_TREE: CatNode[] = [
  { slug: 'oziq-ovqat', uz: 'Oziq-ovqat', cy: 'Озиқ-овқат', ru: 'Продукты', children: [
  ...
  { slug: 'ichimliklar', uz: 'Ichimliklar', cy: 'Ичимликлар', ru: 'Напитки', children: [
  ...
  { slug: 'uy-rozgor', uz: "Uy-ro'zg'or", cy: 'Уй-рўзғор', ru: 'Для дома', children: [
...
const CATALOG: ProdTpl[] = [
  { key: 'sut', family: 'Sut', brand: 'Nestlé', cat: 'sut-mahsulotlari', kw: 'milk,bottle', desc: 'Tabiiy pasterizatsiyalangan sut', variants: [
    { label: 'Sut 0.5L', unitType: 'liter', unitSize: 0.5, price: 7000 },
    { label: 'Sut 1L', unitType: 'liter', unitSize: 1, price: 12000 } ]},
  { key: 'qatiq', family: 'Qatiq', brand: 'Milline', cat: 'sut-mahsulotlari', kw: 'yogurt', variants: [
    { label: 'Qatiq 0.5L', unitType: 'liter', unitSize: 0.5, price: 8000 } ]},
  { key: 'smetana', family: 'Smetana', cat: 'sut-mahsulotlari', kw: 'sour,cream', variants: [
    { label: 'Smetana 400g', unitType: 'gram', unitSize: 400, price: 15000 } ]},
  { key: 'tvorog', family: 'Tvorog', cat: 'sut-mahsulotlari', kw: 'cottage,cheese', variants: [
    { label: 'Tvorog 500g', unitType: 'gram', unitSize: 500, price: 22000 } ]},
  { key: 'pishloq', family: 'Pishloq', cat: 'sut-mahsulotlari', kw: 'cheese', variants: [
    { label: 'Pishloq 300g', unitType: 'gram', unitSize: 300, price: 28000 } ]},
  { key: 'sariyog', family: "Sariyog'", cat: 'sut-mahsulotlari', kw: 'butter', variants: [
    { label: "Sariyog' 200g", unitType: 'gram', unitSize: 200, price: 18000 } ]},
  { key: 'non', family: 'Oddiy non', cat: 'non-nonvoy', kw: 'flatbread,bread', desc: 'Tandirda yopilgan issiq non', variants: [
    { label: 'Oddiy non', unitType: 'piece', unitSize: 1, price: 2500 } ]},
  { key: 'bulochka', family: 'Bulochka', cat: 'non-nonvoy', kw: 'bun,bakery', variants: [
    { label: 'Bulochka', unitType: 'piece', unitSize: 1, price: 1500 } ]},
  { key: 'lavash', family: 'Lavash', cat: 'non-nonvoy', kw: 'lavash,wrap', variants: [
    { label: 'Lavash', unitType: 'piece', unitSize: 1, price: 3000 } ]},
  { key: 'mol', family: "Mol go'shti", cat: 'gosht-parranda', kw: 'beef,meat', desc: "Yangi mol go'shti", variants: [
    { label: "Mol go'shti 1kg", unitType: 'kg', unitSize: 1, price: 95000 } ]},
  { key: 'tovuq', family: "Tovuq go'shti", cat: 'gosht-parranda', kw: 'chicken,raw', variants: [
    { label: "Tovuq go'shti 1kg", unitType: 'kg', unitSize: 1, price: 38000, discount: 34000 } ]},
  { key: 'tuxum', family: 'Tuxum', cat: 'gosht-parranda', kw: 'eggs', variants: [
    { label: 'Tuxum 10 dona', unitType: 'pack', unitSize: 10, price: 16000 } ]},
  { key: 'kolbasa', family: 'Kolbasa', cat: 'gosht-parranda', kw: 'sausage', variants: [
    { label: 'Kolbasa 400g', unitType: 'gram', unitSize: 400, price: 32000 } ]},
  { key: 'olma', family: 'Olma', cat: 'mevalar', kw: 'apple,fruit', variants: [
    { label: 'Olma 1kg', unitType: 'kg', unitSize: 1, price: 12000 } ]},
  { key: 'banan', family: 'Banan', cat: 'mevalar', kw: 'banana', variants: [
    { label: 'Banan 1kg', unitType: 'kg', unitSize: 1, price: 22000 } ]},
  { key: 'apelsin', family: 'Apelsin', cat: 'mevalar', kw: 'orange,fruit', variants: [
    { label: 'Apelsin 1kg', unitType: 'kg', unitSize: 1, price: 18000, discount: 15000 } ]},
  { key: 'uzum', family: 'Uzum', cat: 'mevalar', kw: 'grapes', variants: [
    { label: 'Uzum 1kg', unitType: 'kg', unitSize: 1, price: 20000 } ]},
  { key: 'kartoshka', family: 'Kartoshka', cat: 'sabzavotlar', kw: 'potato', variants: [
    { label: 'Kartoshka 1kg', unitType: 'kg', unitSize: 1, price: 6000 } ]},
  { key: 'piyoz', family: 'Piyoz', cat: 'sabzavotlar', kw: 'onion', variants: [
    { label: 'Piyoz 1kg', unitType: 'kg', unitSize: 1, price: 5000 } ]},
  { key: 'pomidor', family: 'Pomidor', cat: 'sabzavotlar', kw: 'tomato', variants: [
    { label: 'Pomidor 1kg', unitType: 'kg', unitSize: 1, price: 14000 } ]},
  { key: 'bodring', family: 'Bodring', cat: 'sabzavotlar', kw: 'cucumber', variants: [
    { label: 'Bodring 1kg', unitType: 'kg', unitSize: 1, price: 12000 } ]},
  { key: 'sabzi', family: 'Sabzi', cat: 'sabzavotlar', kw: 'carrot', variants: [
    { label: 'Sabzi 1kg', unitType: 'kg', unitSize: 1, price: 7000 } ]},
  { key: 'guruch', family: 'Guruch', brand: 'Laser', cat: 'bakaleya', kw: 'rice,bag', variants: [
    { label: 'Guruch 1kg', unitType: 'kg', unitSize: 1, price: 18000 },
    { label: 'Guruch 5kg', unitType: 'kg', unitSize: 5, price: 85000, discount: 79000 } ]},
  { key: 'makaron', family: 'Makaron', brand: 'Makfa', cat: 'bakaleya', kw: 'pasta', variants: [
    { label: 'Makaron 450g', unitType: 'gram', unitSize: 450, price: 9000 } ]},
  { key: 'yog', family: "O'simlik yog'i", brand: 'Oleyna', cat: 'bakaleya', kw: 'cooking,oil', variants: [
    { label: "Yog' 1L", unitType: 'liter', unitSize: 1, price: 24000 } ]},
  { key: 'un', family: 'Un', brand: 'Oltin Boshoq', cat: 'bakaleya', kw: 'flour', variants: [
    { label: 'Un 2kg', unitType: 'kg', unitSize: 2, price: 16000 } ]},
  { key: 'shakar', family: 'Shakar', cat: 'bakaleya', kw: 'sugar', variants: [
    { label: 'Shakar 1kg', unitType: 'kg', unitSize: 1, price: 12000 } ]},
  { key: 'tuz', family: 'Tuz', cat: 'bakaleya', kw: 'salt', variants: [
    { label: 'Tuz 1kg', unitType: 'kg', unitSize: 1, price: 3000 } ]},
  { key: 'snickers', family: 'Snickers', brand: 'Mars', cat: 'shirinliklar', kw: 'chocolate,bar', variants: [
    { label: 'Snickers 50g', unitType: 'piece', unitSize: 1, price: 6000 } ]},
  { key: 'pechenye', family: 'Pechenye', cat: 'shirinliklar', kw: 'cookies', variants: [
    { label: 'Pechenye 300g', unitType: 'pack', unitSize: 1, price: 12000 } ]},
  { key: 'konfet', family: 'Konfet', brand: 'Roshen', cat: 'shirinliklar', kw: 'candy,sweets', variants: [
    { label: 'Konfet 1kg', unitType: 'kg', unitSize: 1, price: 45000 } ]},
  { key: 'shokolad', family: 'Shokolad', brand: 'Milka', cat: 'shirinliklar', kw: 'chocolate', variants: [
    { label: 'Shokolad 90g', unitType: 'piece', unitSize: 1, price: 14000 } ]},
  { key: 'choy', family: 'Choy', brand: 'Lipton', cat: 'choy-kofe', kw: 'tea,box', variants: [
    { label: 'Choy 100g', unitType: 'gram', unitSize: 100, price: 15000 } ]},
  { key: 'kofe', family: 'Kofe', brand: 'Nescafé', cat: 'choy-kofe', kw: 'coffee', variants: [
    { label: 'Kofe 100g', unitType: 'gram', unitSize: 100, price: 35000 } ]},
  { key: 'cola', family: 'Coca-Cola', brand: 'Coca-Cola', cat: 'suv-gazli', kw: 'cola,bottle', variants: [
    { label: 'Coca-Cola 0.5L', unitType: 'liter', unitSize: 0.5, price: 6000 },
    { label: 'Coca-Cola 1.5L', unitType: 'liter', unitSize: 1.5, price: 12000 } ]},
  { key: 'suv', family: 'Suv', brand: 'Hilol', cat: 'suv-gazli', kw: 'water,bottle', variants: [
    { label: 'Suv 1.5L', unitType: 'liter', unitSize: 1.5, price: 3000 } ]},
  { key: 'pepsi', family: 'Pepsi', brand: 'Pepsi', cat: 'suv-gazli', kw: 'soda,bottle', variants: [
    { label: 'Pepsi 1L', unitType: 'liter', unitSize: 1, price: 9000 } ]},
  { key: 'sharbat', family: 'Sharbat', brand: 'Yashnabod', cat: 'sharbatlar', kw: 'juice', variants: [
    { label: 'Sharbat 1L', unitType: 'liter', unitSize: 1, price: 11000 } ]},
  { key: 'sovun', family: 'Sovun', brand: 'Safeguard', cat: 'gigiena', kw: 'soap', variants: [
    { label: 'Sovun', unitType: 'piece', unitSize: 1, price: 5000 } ]},
  { key: 'shampun', family: 'Shampun', brand: 'Head&Shoulders', cat: 'gigiena', kw: 'shampoo,bottle', variants: [
    { label: 'Shampun 400ml', unitType: 'gram', unitSize: 400, price: 38000 } ]},
  { key: 'tishpasta', family: 'Tish pastasi', brand: 'Colgate', cat: 'gigiena', kw: 'toothpaste', variants: [
    { label: 'Tish pastasi', unitType: 'piece', unitSize: 1, price: 16000 } ]},
  { key: 'kukun', family: 'Kir kukuni', brand: 'Ariel', cat: 'tozalash', kw: 'laundry,detergent', variants: [
    { label: 'Kir kukuni 1.5kg', unitType: 'kg', unitSize: 1.5, price: 42000, discount: 37000 } ]},
];

const SHOP_NAMES = [
  'Baraka Market', 'Mehribon Oziq-ovqat', 'Oltin Boshoq', 'Nasaf Savdo', 'Yetti Iqlim',
  'Hilol Market', 'Diyor Market', 'Bereka', "Anvar Aka Do'koni", 'Sharq Bozori',
  'Qarshi Savdo', 'Bunyodkor Market', 'Oila Market', 'Salom Oziq-ovqat', 'Mega Store',
  'Tong Market', 'Obod Market', 'Marjon Market', 'Chashma', 'Dilshod Savdo',
  'Farovon', 'Iqbol Market', 'Yangi Hayot', 'Bahor Market', 'Mevazor',
  'Suvloq Market', 'Guliston', 'Nur Market', 'Ziyo Savdo', 'Asaka Market',
  'Olamhona', 'Saxiy Market', 'Barakali', 'Quyosh Market', 'Lola Market',
  'Toza Mahsulot', 'Ekonom Market', 'Express Market', 'Qulaylik', 'Hamkor Savdo',
  "Yaqin Do'kon", "Mo'jiza Market", 'Sano Market', 'Davr Market', 'Istiqlol Savdo',
  'Buyuk Ipak', 'Zilol Market', 'Shifo Market', 'Marhamat', 'Suhrob Savdo',
];
const STREETS = [
  'Mustaqillik', 'Amir Temur', 'Nasaf', "Ulug'bek", 'Bunyodkor', 'Islom Karimov',
  'Shifokorlar', "G'allaorol", 'Kohna Qala', 'Beruniy', 'Navoiy', 'Mirzo Bobur',
];
const OWNER_NAMES = [
...
async function seed() {
  ...
  if (existingShops >= 40) {
    console.log(`⚠️ ${existingShops} shops already exist — aborting to avoid duplicates.`);
  ...
  const catBySlug = new Map<string, Category>(existingCats.map((c) => [c.slug, c]));
  let sort = existingCats.length;
  for (const root of CATEGORY_TREE) {
    let parent = catBySlug.get(root.slug);
    if (!parent) {
      parent = await catRepo.save(catRepo.create({
        slug: root.slug, nameUzLatn: root.uz, nameUzCyrl: root.cy, nameRu: root.ru,
        sortOrder: sort++, parent: null,
      }));
      catBySlug.set(root.slug, parent);
    }
    for (const child of root.children ?? []) {
      if (catBySlug.get(child.slug)) continue;
      const node = await catRepo.save(catRepo.create({
        slug: child.slug, nameUzLatn: child.uz, nameUzCyrl: child.cy, nameRu: child.ru,
        sortOrder: sort++, parent,
      }));
  ...
  for (let i = 0; i < OWNER_NAMES.length; i++) {
    owners.push(await userRepo.save(userRepo.create({
  ...
  for (let i = 0; i < CATALOG.length; i++) {
    prodImg.set(CATALOG[i].key, await seedImage(`prod-${CATALOG[i].key}`, CATALOG[i].kw, 100 + i));
  }
  ...
  for (let si = 0; si < shopCount; si++) {
    ...
    const shop = await shopRepo.save(shopRepo.create({
      ownerId: owner.id,
      name,
      description: pick([
      ...
      photos: [shopImg[si % shopImg.length], shopImg[(si + 3) % shopImg.length]],
    ...
    const mkStaff = async (preset: 'kassir' | 'yetkazib_beruvchi', role: string) => {
      ...
      await staffRepo.save(staffRepo.create({
        shopId: shop.id, userId: u.id, customRoleName: role, preset,
        permissions: PRESET_PERMISSIONS[preset], isActive: true,
      }));
    };
