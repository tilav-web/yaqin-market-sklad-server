...
export class OrderComplaints1783326705653 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."order_complaints_status_enum" AS ENUM('open', 'resolved')`);
        await queryRunner.query(`CREATE TABLE "order_complaints" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "orderId" uuid NOT NULL, "customerId" uuid NOT NULL, "shopId" uuid NOT NULL, "reason" character varying(256) NOT NULL, "description" text, "status" "public"."order_complaints_status_enum" NOT NULL DEFAULT 'open', "resolution" text, "resolvedByAdminId" uuid, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "resolvedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_ef3e87f5fc7797546c819035e4c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_fa8cff72bbab578a03022d9c95" ON "order_complaints"  ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_0d21708188f6d995f637b08a07" ON "order_complaints"  ("shopId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_9b75df80c67bf2d8380f57b4f9" ON "order_complaints"  ("orderId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9b75df80c67bf2d8380f57b4f9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0d21708188f6d995f637b08a07"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fa8cff72bbab578a03022d9c95"`);
        await queryRunner.query(`DROP TABLE "order_complaints"`);
        await queryRunner.query(`DROP TYPE "public"."order_complaints_status_enum"`);
    }
