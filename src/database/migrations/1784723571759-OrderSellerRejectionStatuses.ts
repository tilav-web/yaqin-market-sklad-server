...
export class OrderSellerRejectionStatuses1784723571759 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."orders_status_enum" ADD VALUE 'seller_no_response'`);
        await queryRunner.query(`ALTER TYPE "public"."orders_status_enum" ADD VALUE 'seller_rejected'`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum_old" AS ENUM('new', 'accepted', 'preparing', 'delivering', 'delivered', 'cancelled')`);
