...
export class InventoryBrakReason1783327248419 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."inventory_movements_brakreasoncode_enum" AS ENUM('expired', 'damaged', 'stolen', 'other')`);
        await queryRunner.query(`ALTER TABLE "inventory_movements" ADD "brakReasonCode" "public"."inventory_movements_brakreasoncode_enum"`);
        await queryRunner.query(`ALTER TABLE "inventory_movements" ADD "brakReasonNote" text`);
        ...
        await queryRunner.query(`ALTER TYPE "public"."inventory_movements_type_enum" ADD VALUE 'damaged'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."inventory_movements_type_enum_old" AS ENUM('in', 'sold', 'returned', 'expired', 'adjusted')`);
        ...
        await queryRunner.query(`ALTER TABLE "inventory_movements" DROP COLUMN "brakReasonNote"`);
        await queryRunner.query(`ALTER TABLE "inventory_movements" DROP COLUMN "brakReasonCode"`);
        await queryRunner.query(`DROP TYPE "public"."inventory_movements_brakreasoncode_enum"`);
    }
