...
export class ClickPaymentTransactionError1785214490098 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "click_payment_transaction" ADD "errorCode" integer`);
        await queryRunner.query(`ALTER TABLE "click_payment_transaction" ADD "errorNote" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "shop_staff_presets" ALTER COLUMN "permissions" SET DEFAULT '[]'::jsonb`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "shop_staff_presets" ALTER COLUMN "permissions" SET DEFAULT '[]'`);
        ...
        await queryRunner.query(`ALTER TABLE "click_payment_transaction" DROP COLUMN "errorNote"`);
        await queryRunner.query(`ALTER TABLE "click_payment_transaction" DROP COLUMN "errorCode"`);
    }
