...
export class AnalyticsEvents1783326969341 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."analytics_events_type_enum" AS ENUM('product_view', 'add_to_cart')`,
    );
    await queryRunner.query(
      `CREATE TABLE "analytics_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."analytics_events_type_enum" NOT NULL, "userId" uuid, "shopId" uuid NOT NULL, "productVariantId" uuid, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_5d643d67a09b55653e98616f421" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2eaecd729184255b9128dd851e" ON "analytics_events"  ("shopId", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1413b837e8bec77307f42c3022" ON "analytics_events"  ("type", "createdAt") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1413b837e8bec77307f42c3022"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2eaecd729184255b9128dd851e"`,
    );
